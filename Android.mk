# Copyright (C) 2015 The Darkobas Project
#
...
LOCAL_SRC_FILES := prebuilt/PrebuiltBugle.apk
...
LOCAL_MODULE_OWNER := CAF
LOCAL_SRC_FILES := prebuilt/chromium.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := PRESIGNED
...
LOCAL_MODULE_OWNER := com.danielkim.soundrecorder
LOCAL_SRC_FILES := prebuilt/SoundRecorder.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := PRESIGNED
